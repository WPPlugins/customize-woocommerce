...
function woocommerce_styler_init_slider(){
	jQuery('.slider').remove();
	jQuery('.woocommerce_styler_simple_slider').each(function(k,v){
		var slide = jQuery(v);
		slide.simpleSlider({
...
jQuery(function($){
	//woocommerce_styler_field_callbacks.push('woocommerce_styler_init_slider');
	woocommerce_styler_init_slider();
	$(document).ajaxSuccess(function(e, xhr, settings) {
		if(settings.data){
			if(settings.data.search('action=save-widget') != -1 && settings.data.search('woocommerce_styler') != -1) {
				woocommerce_styler_init_slider();
			}
		}
	});
